...
## 2D Example
Here's a basic example for plotting a 2D robot's workspace via `plot2dworkspace`:
```Matlab
...
## 3D Example
Here's a basic example for plotting a 3D robot's workspace via `plot3dworkspace`:
```Matlab
